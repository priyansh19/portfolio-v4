// Vertex + fragment shaders for the displacement sphere.
// Ported verbatim from Hamish Williams' portfolio (MIT).
// The noise functions are Stefan Gustavson's classic Perlin/periodic
// noise (webgl-noise, MIT).
