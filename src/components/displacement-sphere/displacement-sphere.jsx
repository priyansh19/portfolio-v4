...
import { media, useInViewport, useWindowSize } from '@/lib/hooks';
import { throttle } from '@/lib/throttle';
import { cleanRenderer, cleanScene, removeLights } from '@/lib/three-utils';
...
export const DisplacementSphere = ({ className = '', ...rest }) => {
  ...
  useEffect(() => {
    ...
    // Stamped on mount rather than during render — Date.now() is impure
    ...
    const visibilityTimeout = setTimeout(() => setVisible(true), 100);
